...
RcppExport SEXP _detrendr_boxcar_smooth(SEXP extendedSEXP, SEXP lSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type extended(extendedSEXP);
    Rcpp::traits::input_parameter< std::size_t >::type l(lSEXP);
    rcpp_result_gen = Rcpp::wrap(boxcar_smooth(extended, l));
    return rcpp_result_gen;
END_RCPP
}
// weighted_smooth
NumericVector weighted_smooth(NumericVector extended, NumericVector weights);
RcppExport SEXP _detrendr_weighted_smooth(SEXP extendedSEXP, SEXP weightsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type extended(extendedSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type weights(weightsSEXP);
    rcpp_result_gen = Rcpp::wrap(weighted_smooth(extended, weights));
    return rcpp_result_gen;
END_RCPP
}
// exp_smooth
NumericVector exp_smooth(NumericVector extended, double tau, std::size_t l);
RcppExport SEXP _detrendr_exp_smooth(SEXP extendedSEXP, SEXP tauSEXP, SEXP lSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type extended(extendedSEXP);
    Rcpp::traits::input_parameter< double >::type tau(tauSEXP);
    Rcpp::traits::input_parameter< std::size_t >::type l(lSEXP);
    rcpp_result_gen = Rcpp::wrap(exp_smooth(extended, tau, l));
    return rcpp_result_gen;
END_RCPP
}
// square_root_
