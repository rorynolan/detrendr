...
First decide whether or not your images need to be thresholded or not. Again, if some need to be thresholded and some don't, put these in separate directories and detrend them separately. Always rememer to check that the detrending worked satisfactorily when it has been employed.
